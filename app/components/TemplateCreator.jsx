...
import { X, Type, Image as ImageIcon, Save, Trash2, Plus, Minus, Move } from 'lucide-react';
            ...
            <motion.div
               ...
               <motion.div
                  ...
                  <div className="px-8 py-6 border-b border-neutral-100 flex items-center justify-between">
                     <div>
                        <h2 className="text-2xl font-light italic text-[#c09a74]" style={{ fontFamily: "'Playfair Display', serif" }}>
                           Template Creator
                        </h2>
                  ...
                  <div className="flex-1 flex overflow-hidden">
                     {/* Sidebar */}
                     <div className="w-80 border-r border-neutral-100 flex flex-col p-6 gap-8 overflow-y-auto">
                        <div className="space-y-4">
                           ...
                           <div className="grid grid-cols-1 gap-3">
                              ...
                              >
                                 ...
                                 <div>
                                    <span className="block text-sm font-bold">Image Placeholder</span>
                                    <span className="text-[10px] text-neutral-500">Drag to position watch images</span>
                                 </div>
                              </button>
                              <button
                              ...
                              >
                                 ...
                                 <div>
                                    <span className="block text-sm font-bold">Text Element</span>
                                    <span className="text-[10px] text-neutral-500">Add titles or descriptions</span>
                                 </div>
                              </button>
                           </div>
                        </div>
                        ...
                        {selectedElement && (
                           <div className="space-y-6 pt-6 border-t border-neutral-100">
                              ...
                              {selectedElement.type === 'text' && (
                                 <div className="space-y-4">
                                    <div className="space-y-2">
                                       <label className="text-[10px] uppercase tracking-widest font-bold text-neutral-400">Content</label>
                                       <input 
                                          type="text"
                                    ...
                                    <div className="flex items-center justify-between">
                                       <label className="text-[10px] uppercase tracking-widest font-bold text-neutral-400">Size</label>
                                       <div className="flex items-center gap-3">
                                          <button 
                                             onClick={() => updateElement(selectedId, { fontSize: Math.max(12, selectedElement.fontSize - 2) })}
                                             className="p-1 rounded-md bg-neutral-100 hover:bg-neutral-200"
                                          ><Minus size={14}/></button>
                                          <span className="text-xs font-bold">{selectedElement.fontSize}</span>
                                          <button 
                              ...
                              <div className="space-y-2">
                                 <label className="text-[10px] uppercase tracking-widest font-bold text-neutral-400">Dimensions</label>
                                 <div className="grid grid-cols-2 gap-2">
                                    <div className="bg-neutral-50 rounded-xl p-2 text-center">
                                       <span className="block text-[8px] uppercase text-neutral-400 font-bold">Width</span>
                                       <span className="text-xs font-bold">{Math.round(selectedElement.width)}px</span>
                                    </div>
                                    <div className="bg-neutral-50 rounded-xl p-2 text-center">
                                       <span className="block text-[8px] uppercase text-neutral-400 font-bold">Height</span>
                                       <span className="text-xs font-bold">{Math.round(selectedElement.height)}px</span>
                                    </div>
                                 </div>
                              </div>
                           </div>
                     ...
                     {/* Canvas */}
                     <div className="flex-1 bg-neutral-50 p-12 overflow-y-auto flex justify-center">
                        <div 
                           className="bg-white shadow-2xl relative overflow-hidden" 
                           style={{ width: '800px', height: '1131px', minHeight: '1131px' }}
                        >
                                 ...
                                 {el.type === 'image' ? (
                                    <div className="w-full h-full bg-neutral-100 flex items-center justify-center border-2 border-dashed border-neutral-300 relative group">
                                       ...
                                       <div className="absolute inset-0 bg-black/0 group-hover:bg-black/5 transition-colors flex items-center justify-center">
                                          <Move size={16} className="text-white opacity-0 group-hover:opacity-100" />
                                       </div>
                           ...
                           {elements.length === 0 && (
                              <div className="absolute inset-0 flex flex-col items-center justify-center text-neutral-300 pointer-events-none">
                                 ...
                                 <p className="text-lg font-light italic" style={{ fontFamily: "'Playfair Display', serif" }}>
